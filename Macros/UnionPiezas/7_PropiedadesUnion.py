...
propertyelement3d_2 = apex.catalog.getPropertiesElement3D( name = "Tornillo" )
...
propertyelement3d_9 = apex.catalog.getPropertiesElement3D( name = "3D Element Property 4" )
propertyelement3d_9.update(
    name = 'PiezaInferior',
)

propertyelement3d_10 = apex.catalog.getPropertiesElement3D( name = "PiezaInferior" )
_target = apex.EntityCollection()
...
propertyelement3d_19 = apex.catalog.getPropertiesElement3D( name = "3D Element Property 5" )
...
propertyelement3d_21 = apex.catalog.getPropertiesElement3D( name = "3D Element Property 6" )
...
propertyelement3d_23 = apex.catalog.getPropertiesElement3D( name = "3D Element Property 7" )
