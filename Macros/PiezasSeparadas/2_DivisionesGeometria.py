...
#######################################################################################
#
#               Visualizacion de los puntos para dividir Planos
#
#######################################################################################
...
#######################################################################################
#
#              Division de todas las piezas menos la Cabeza del tornillo, 
#       el interior del cuerpo del tornillo y la pieza inf inferior cilindrica
#
#######################################################################################
...
# solo aqui esta la pieza inferior interior / cilindro
part_50 = apex.getPart( pathName = apex.currentModel().name + "/Union_Apex/Product1/RestoPiezaInferior/P_Inferior_Interior" )
solid_50 = part_50.getSolid( name = "P_Inferior_Interior" )
_target.append( solid_50 )
...
# # Paso 4: Crear plano horizontal con tres vertices del grupo intermedio
# if len(middle_vertices) < 3:
#     raise Exception("No hay suficientes vertices en la altura intermedia para definir un plano")
...
# print("Division completada con plano horizontal en Z =", z_middle)


_target = apex.EntityCollection()
# Obtener la parte y solido
part = apex.getPart(pathName = apex.currentModel().name + "/Union_Apex/Cabeza_Tornillo/PartBody")
solid = part.getSolid(name = "PartBody")
...
print(" Corte realizado con exito. El solido fue dividido por el plano ZX (Y=0).")
